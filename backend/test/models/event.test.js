...
describe('models/event', () => {
    ...
    it('check getRoomEventsBeetwenDates method', async function () {
        ...
        // 10:30-10:40
        date_eng = new Date('2021 10:30'); 
        date_end = new Date('2021 10:40'); 
        Event.getRoomEventsBeetwenDates(event.roomId, date_start, date_end, false, (err, res) => {
        ...
        // date_eng = new Date('2021 10:30'); 
        // date_end = new Date('2021 10:41'); 
        // Event.getRoomEventsBeetwenDates(event.roomId, event.date_start, event.date_end, false, (err, res) => {
